...
/**
 * Every size is a notch taller than the shadcn default. The screen this runs on
 * is a small wall-mounted Android terminal operated with a thumb, at speed, and
 * a 28px control is a mis-tap waiting to happen — the shapes, colours and
 * spacing are unchanged, only the height a finger has to find.
 */
